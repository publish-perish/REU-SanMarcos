...
\hspace{5mm}$A$ // generators\\
\hspace{5mm}$Q$  // m coefficients\\
\hspace{5mm}$x$  // x coefficients\\
\vspace{5mm}
...
\hspace{5mm}\textbf{Define} $X$ a polynomial of $A$ and $x$
\vspace{2mm}

\hspace{5mm}\textbf{If} $X$ is well formed
\vspace{1mm}

\hspace{10mm}\textbf{Define} polynomial

\hspace{15mm}$Adj = X - M$ // mod our X polynomial

\hspace{10mm}\textbf{end}
\vspace{1mm}

\hspace{10mm}\textbf{If} covering is $true$

\hspace{15mm}save the polynomial $M$ 
