...
\frame{
 ...
 \item<1-> ie circulant graphs give better communication networks than cubes
 \item<1->  the diameter of a network represents that maximum communication delay between two nodes in the network. 
